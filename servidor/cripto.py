...
if __name__ == "__main__":
    ...
    msg_encriptado_2 = encriptar(mensaje)
    mensaje_desencriptado_2 = desencriptar(msg_encriptado_2)

    print(hola)
    print("encripatado: ", msg_encriptado_2)
    print("desncriptado: ", mensaje_desencriptado_2)

    print( mensaje == mensaje_desencriptado_2)
